		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cpccomparativeanalysis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cpccomparativeanalysis-display": {
								"semanticObject": "cpccomparativeanalysis",
								"action": "display",
								"description": "CPC Comparative Analysis",
								"title": "Comparative Analysis",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cpccomparativeanalysis",
									"url": sap.ui.require.toUrl("cpccomparativeanalysis")
								}
							}
						}
					}
